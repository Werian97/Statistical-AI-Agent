...
from data.read_write_data import save_csv

Row = list[str]
Rows = list[Row]
Filters = dict[str, dict[str, str | dict[str, float | str]]]
...
def filter(table: Table, filters: Filters):
    ...
    return save_csv(filtered_table)
